$(function(){
		...
		*/
		$.merge(columns,[
			...
			{id: "category", name:lang['grid.title.category'],width:40, field:"category", editor:Slick.Editors.AnbaseCategory, formatter:Slick.Formatters.Category},
			{id: "deal_type", name:lang['grid.title.deal_type'], field:"deal_type",width:40, editor:Slick.Editors.AnbaseDealType, formatter:Slick.Formatters.Dealtype}
		]);
		...
		* Создание грида
		*/
		var model = new Slick.Data.RemoteModel({BaseUrl:manager.baseUrl+'?act=view&s=my',PrintUrl:manager.baseUrl+'?act=print',PageSize:200});	
		...
		*/
		$('#print_order').click(function(){
			manager.orders.print_orders(grid,model);
		});
		/*
