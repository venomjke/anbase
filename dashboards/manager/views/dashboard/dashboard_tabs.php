<div id="dashboard_tabs">
	<?php
		$tabs = array(
			anchor("manager/orders/?act=view&sct=my","Мои заявки"),
			anchor("manager/orders/?act=view&sct=free","Свободные заявки"),
			anchor("manager/orders/?act=view&sct=delegate","Заявки агентов")
		);
		echo ul($tabs);
	?>
