...
<script type="text/javascript">
	$(function(){
		...
		*/
		agent.orders.show_full_text = function(event,row,cell){
			...
			if($(tooltip_id).length>0){
				...
				var tooltip = $('<div>').html(data[row].description);
		...
		*/
		...
		var columns = [
			{id: "number", name:"Номер", field:"number", width:70, height:100 },
			{id: "create_date", name:"Дата создания", field:"create_date", width:118, editor:Slick.Editors.Date},
			{id: "category", name:"Объект", field:"category", width:75 },
			{id: "deal_type", name:"Сделка", field:"deal_type", width:80 },
			{id: "region",  name:"Район", field:"region", width:141 },
			{id: "metro", name:"Метро", field:"metro", width:140 },
			{id: "price", name:"Цена", field:"price", width:100, formatter:Slick.Formatters.Rubbles },	
			{id: "description", name:"Описание", field:"description", width:400, formatter:descriptionFormatter, editor:Slick.Editors.LongText},
			{id: "phone", name:"Телефон", field:"phone", width:160 }
		];
