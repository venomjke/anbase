								...
								<table width="100%" border="0" cellpadding="4px" cellspacing="0px">
									<tr>
	 								<td class="l">Фамилия:</td>
						   			 <td><input class="text personal" name="last_name" type="text" value="<?php echo $this->agent_users->get_user_last_name(); ?>" required /></td>
									</tr>
									<tr>
										<td class="l">Имя:</td>
					    				<td><input class="text personal" type="text" name="name" value="<?php echo $this->agent_users->get_user_name();?>" required/></td>
									</tr>
									<tr>
										 <td class="l">Отчество:</td>
						    			 <td><input class="text personal" type="text" name="middle_name" value="<?php echo $this->agent_users->get_user_middle_name(); ?>" required/></td>
									</tr>
									<tr>
