    ...
    */
    ...
    function ensureData(from, to) {
      ...
      */
      ...
      var filter_string = "number="+number+"&phone="+phone+"&category="+category+"&dealtype="+dealtype+"&price_to="+price_to+"&price_from="+price_from+"&createdate_to="+createdate_to+"&createdate_from="+createdate_from+"&description="+description;

      var param_string = options.BaseUrl.indexOf('?') != -1?"&offset=" + (fromPage * options.PageSize) + "&limit="+options.PageSize+"&"+filter_string:"?offset=" + (fromPage * options.PageSize) + "&limit="+options.PageSize+"&"+filter_string;
